...
#Non-random
CAR_DICT = {
    0 : Car("south", "left", 90, True, 0),
    1 : Car("north", "left", 90, True, 0),
    2 : Car("south", "left", 80, True, 0),
    3 : Car("north", "left", 80, True, 0),
    4 : Car("south", "left", 70, True, 0),
    5 : Car("north", "left", 70, True, 0),
    6 : Car("south", "left", 60, True, 0),
    7 : Car("north", "left", 60, True, 0),
    8 : Car("east", "left", 90, True, 0),
